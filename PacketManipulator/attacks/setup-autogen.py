...
class Autogen(object):
    ...
    def _create_setup(self, path):
        ...
        attack_type = getattr(mod, '__attack_type__', -1)

        if attack_type != -1:
            print "Writing attack part .."
            out += '    attack_type=%d,\n' % attack_type
...
if __name__ == '__main__':
    ...
    optparse.add_option('-b', '--build', action='store_true', dest='build', help='Set it to build attacks')
