...
dissector.imap.info IMAP CRAM-MD5 : 10.0.1.102:143 -> USER: hemmingway Digest:
29f20b669347aa081749065d903a49e4
...
def imap_dissector():
    ...
    def imap(mpkt):
        ...
        elif isinstance(sess.data, list) and \
        sess.data[0] == 'AUTHENTICATE CRAM-MD5':
...
__vulnerabilities__ = (('IMAP dissector', {
    'description' : 'The Internet Message Access Protocol (commonly known as '
    'IMAP) is an Application Layer Internet protocol that allows an e-mail '
