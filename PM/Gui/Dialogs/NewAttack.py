...
class NewAttackDialog(gtk.Dialog):
    def __init__(self, parent):
        super(NewAttackDialog, self).__init__(
            _('New attack - PacketManipulator'), parent,
    ...
    def __on_changed(self, widget, btn):
        # This is to avoid launching an attack without having a proper selection
